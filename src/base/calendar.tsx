...
import { Button, buttonVariants } from '@/base/button.js';
...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        `
          group/calendar bg-background p-3 [--cell-radius:var(--radius-md)]
          [--cell-size:--spacing(8)]
      ...
      components={{
        ...
        /* eslint-enable @eslint-react/no-nested-component-definitions */
        ...components,
      }}
      {...props}
    />
...
function CalendarDayButton({
  ...
  locale,
  ...props
}: React.ComponentProps<typeof DayButton> & { readonly locale?: Partial<Locale> }) {
  const defaultClassNames = getDefaultClassNames();
